...
## Functions
 ...
 + VERY ALPHA **func_makeMVbase** generates a base mapview with several key WMS services that is suited to additional spatial data layers via `+`. Currently seems to crash Rstudio when the "GSWrecur[rence]" base group tiles are enabled 
